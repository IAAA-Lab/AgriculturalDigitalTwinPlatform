...
async def clean(input: Input_Clean) -> list[dict]:
    ...
    activities = activities[activities["enclosureId"] == input.digital_twin_id]
    # Drop rows with undefined activity, date or parcel
    activities = activities.dropna(subset=["activity", "date", "enclosureId"])
    # Drop duplicates
    activities = activities.drop_duplicates()
    # Select columns
    activities = activities[["date", "activity", "enclosureId"]]
