...
type EventHandler struct {
	...
	eventsBus      ports.ParcelsESB
	eventsInInt    chan domain.EventIn
	routingKeyMap  map[string]chan amqp091.Delivery
}

func NewEventHandler(parcelsService ports.ParcelsService, memoryStorage ports.CacheService, eventsBus ports.ParcelsESB) *EventHandler {
	return &EventHandler{
...
// 					continue
// 				}
// 				if eventExt.ErrorMessage != "" {
// 					log.Println("Error in external event: ", eventExt.ErrorMessage)
// 					continue
// 				}
...
// 		fmt.Println("Error marshalling event", err1, err2)
// 		msgInt.Channel <- domain.EventOut{
// 			ErrorMessage: apperrors.ErrInternal.Error(),
// 			Payload:      nil,
// 		}
// 		return
// 	}
