...
import (
	...
	eventhdl "prakticas/backend-gpsoft/src/internal/adapters/primary/event-handler"
	imageshdl "prakticas/backend-gpsoft/src/internal/adapters/primary/rest-api/images-hdl"
	encryptionmw "prakticas/backend-gpsoft/src/internal/adapters/primary/rest-api/middleware/encryption-mw"
	jwtmw "prakticas/backend-gpsoft/src/internal/adapters/primary/rest-api/middleware/jwt-mw"
	newshdl "prakticas/backend-gpsoft/src/internal/adapters/primary/rest-api/news-hdl"
	parcelshdl "prakticas/backend-gpsoft/src/internal/adapters/primary/rest-api/parcels-hdl"
	usershdl "prakticas/backend-gpsoft/src/internal/adapters/primary/rest-api/users-hdl"
	aes256repo "prakticas/backend-gpsoft/src/internal/adapters/secondary/aes-256"
	localfilestoragerepo "prakticas/backend-gpsoft/src/internal/adapters/secondary/local-file-storage"
	"prakticas/backend-gpsoft/src/internal/adapters/secondary/mongodb"
	rabbitmqrepo "prakticas/backend-gpsoft/src/internal/adapters/secondary/rabbitmq"
	redisrepo "prakticas/backend-gpsoft/src/internal/adapters/secondary/redis"
	...
	imagessrv "prakticas/backend-gpsoft/src/internal/core/services/image-srv"
	newssrv "prakticas/backend-gpsoft/src/internal/core/services/news-srv"
	parcelssrv "prakticas/backend-gpsoft/src/internal/core/services/parcels-srv"
